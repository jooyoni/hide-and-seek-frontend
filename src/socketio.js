...
export const initSocketConnection = () => {
    ...
    socket.on("gameEnd", (wonTeam) => {
        console.log("gameEnd", wonTeam);
        store.dispatch(gameInfoActions.gameEnd(wonTeam));
        store.dispatch(usersActions.gameEnd());
        store.dispatch(meActions.gameEnd());
    });
